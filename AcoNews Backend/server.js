...
const GNEWS_API_KEY = "4f0cfd1813cfd0c8e010919f17be958b"; // Make sure this is your correct API key
...
app.get("/", (req, res) => {
  res.send(
    "Welcome to the Acowale News API! Use /news endpoint to fetch articles."
  );
});
